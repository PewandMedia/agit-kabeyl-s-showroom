...
export function VehicleCard({
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden bg-surface-2 md:aspect-video">
        <img
          ...
          className={`h-full w-full object-cover transition-transform duration-500 ease-out group-hover:scale-105 ${
            isSold ? "opacity-50 grayscale" : "md:opacity-80 md:grayscale md:group-hover:grayscale-0 md:group-hover:opacity-100"
          }`}
        />
      ...
      <div className="space-y-4 p-5 md:space-y-6 md:p-6">
        <div>
          ...
          <div className="mt-2 font-display text-2xl font-extrabold text-champagne md:text-xl">
