...
export function StickyWhatsAppFab() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-40 hidden h-16 w-16 items-center justify-center rounded-full bg-[oklch(0.62_0.17_150)] text-white shadow-[0_10px_30px_-10px_rgba(0,0,0,0.5)] transition-transform hover:scale-105 md:flex"
    >
